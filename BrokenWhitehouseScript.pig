-- To Run: use pig -p I_PARSED_DATA=/dataset-derived/gov/parsed/arcs/bucket-0/ -p I_CHECKSUM_DATA=/dataset/gov/url-ts-checksum/ -p O_DATA_DIR=output0_13Aug file_to_counts_plus_UR
Ls.pig
...
Meta = FILTER Meta BY src MATCHES ('.*whitehouse\.gov.*);
